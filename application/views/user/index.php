    ...
    <div class="container" style="margin-top: 1%">
        <div class="row">
            <div class="col-md-12 jumbotron">
                <h2 class="text-primary">jQuery Quiz Game: User (Here you can Add <span class="text-success">Questions</span>)</h2>
            </div>
        </div>
        <br>
       ...
       <br>
        ...
        <div class="row">
         <div class="col-md-12">
          ...
          <a href="<?= base_url('User/select') ?>" class="btn btn-primary float-right">Next</a>
         </div>
        </div>
        <br>
