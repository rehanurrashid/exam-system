...
<html lang="en">
  ...
  <body>
    <div class="jumbotron jumbotron-fluid">
        <h2 class="text-primary ml-5">Admin: <span class="text-success">Screen: 11</span></h2>
        <h2 class="text-danger ml-5">Edit Exercise for Arrange Sentence </h2>
        ...
        $('#msgDiv').load('<?= base_url('admin/onload_questions_display/')?>', // url 
                ...
                if(data.length>0){
                    for(var item in data){
                                ...
                                template +=       `<h3>${data[item].question}</h3>`;
...
var wordid,wordname,qid;
    ...
    // inserting questions using jason request
        $('#addquestion').click(function(){
            ...
            $.get(`<?= base_url('admin/insert')?>`,{eid:exeid,question:que},function(_data){
                var data = JSON.parse(_data);   
            });
            location.reload();
        });
