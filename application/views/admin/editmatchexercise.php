...
<html lang="en">
  ...
  <body>
    <div class="jumbotron jumbotron-fluid">
        <h2 class="text-primary ml-5">Admin: <span class="text-success">Screen: 9</span></h2>
    ...
    <div class="container" style="margin-top: 1%">
        <div class="row">
            <div class="col-md-12">
                ...
                <a style="cursor: pointer;" data-toggle="modal" data-target="#deleteExercise"   class="btn btn-danger float-right w-100 text-white">Delete this Exercise</a>
                </div>
            </div>
        </div>
    ...
    <footer class="col-md-12" style="position:fixed;bottom:0;padding:0">
        ...
        <a href="<?= base_url('admin/exercise') ?>" class="btn btn-primary w-25"><i class="fas fa-arrow-left"></i> Back to Exercises</a>

        <div class="w-50">
            <?php  echo form_open('admin/update_exercise'); ?>
            <?php echo form_submit(['name'=> 'submit','value'=>'Update Exercise','class'=>'btn btn-dark w-50 mr-5 float-right' ]);  ?>
            <?php  echo form_close(); ?>
        </div>
...
<div id="msgDiv" style="display:none"></div>
    ...
    <div class="modal fade" id="addQuestion" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            ...
            <div class="modal-body">
                    <?php  echo form_open_multipart('admin/store_match_question'); ?>
                <div class="form-group">
                    <label >Image Name:</label>
                    <input style="display:none" type="text" class="form-control"  name="eid" value="<?= $data['exercise']['eid']; ?>">
                    ...
                    <input style="display:none" type="text" class="form-control"  name="qtitle" value="<?= $data['exercise']['qtitle']; ?>">
                    <input style="display:none" type="text" class="form-control"  name="check" value="3">
                    <input type="text" class="form-control" id="question" name="imgname"  placeholder="Enter Image Name">
                </div>
                <div class="form-group">
     ...
     <div class="modal fade" id="editQuestion" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                        <?php  echo form_open_multipart('admin/edit_match_question'); ?>
                    <div class="form-group">
                        <label >Image Name:</label>
                        <input style="display:none" type="text" class="form-control"  name="eid" value="<?= $data['exercise']['eid']; ?>">
                        <input style="display:none" type="text" class="form-control"  name="category" value="<?= $data['category']['cid']; ?>">
                        <input style="display:none" type="text" class="form-control"  name="type" value="<?= $data['type']['tid']; ?>">
                        <input style="display:none" type="text" class="form-control"  name="qtitle" value="<?= $data['exercise']['qtitle']; ?>">
                        <input style="display:none" type="text" class="form-control"  name="mid" id="editid">
                        <input style="display:none" type="text" class="form-control"  name="check" value="3">
                        <input type="text" class="form-control" id="editquestion" name="imgname"  placeholder="Enter Image Name">
                    </div>
                ...
                <div class="modal-footer mt-3">
                    ...
                    ?>
                    <?php  echo form_close(); ?>
                    <?php  echo form_open('admin/delete_match_question'); ?>
                        <input style="display:none" type="text" class="form-control"  name="eid" value="<?= $data['exercise']['eid']; ?>">
                        <input style="display:none" type="text" class="form-control"  name="category" value="<?= $data['category']['cid']; ?>">
                        <input style="display:none" type="text" class="form-control"  name="type" value="<?= $data['type']['tid']; ?>">
                        <input style="display:none" type="text" class="form-control"  name="qtitle" value="<?= $data['exercise']['qtitle']; ?>">
                        <input style="display:none" type="text" class="form-control"  name="check" value="3">
                        <input style="display:none" type="text" class="form-control"  name="mid" id="deleteid">
    ...
    <div class="modal fade" id="deleteExercise" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title text-danger" id="exampleModalCenterTitle">Caution!</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
            <div class="form-group">
                <h5>Are you sure you want to delete complete Exercise?</h5>
            </div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                <?php  echo form_open('admin/delete_exercise'); ?>
                    <input style="display:none" type="text" class="form-control" name="eid" value="<?= $data['exercise']['eid']; ?>">
...
<script type="text/javascript">
    jQuery(document).ready(function(){ 
        ...
        $('#msgDiv').load('<?= base_url('admin/onload_match_que_display')?>', // url 
                ...
                template +=		`<td class="align-middle" ><h4>${data[item].imgname}</h4></td>
                <td style="display:none" ><h4>${data[item].imgname}</h4></td>
								<td class="align-middle">
                                <button data-toggle="modal" data-target="#editQuestion" class="btn btn-primary w-100" id="editbtn`+ editbtn++ +`">Edit</button>
                                <p style="display:none">${data[item].mid}</p>
                                </td>
