...
<html lang="en">
  ...
  <body id="body" class="body">
    <div class="jumbotron jumbotron-fluid">
        <h2 class="text-primary ml-5">Admin: <span class="text-success">Screen: 3</span></h2>
    ...
    <div class="container" style="margin-top: 1%">
       ...
       <div class="row">
        ...
        <br>
        <?php  echo form_open('admin/next_form'); ?>
            <div class="row d-flex flex-row justify-content-center">
                ...
                <div class="col-md-3 mr-5 text-center shadow-lg p-3 mb-5 bg-white rounded">
                    <label for="radio-4">Arrange Sentence</label>
                    <input type="radio" name="type" id="radio-4" value="4">
                </div>  
            </div>
                <div class="col-md-12">
    ...
    <footer class="col-md-12" style="position:fixed;bottom:0;padding:0">
        <nav class="navbar navbar-light d-flex bd-highlight" style="background-color:#E9ECEF">
            <div class="mr-auto p-2 bd-highlight w-50">
                <a href="<?= base_url('admin/exercise') ?>" class="btn btn-primary w-50"><i class="fas fa-arrow-left"></i> Back to Exercise</a>
            </div>
