...
<html lang="en">
  ...
  <body id="body" class="body">
    <div class="jumbotron jumbotron-fluid">
        <h2 class="text-primary ml-5">Admin: <span class="text-success">Screen: 2</span></h2>
        <h2 class="text-primary ml-5">Here you can Add and Edit <span class="text-success">Exercises</span></h2>
    </div>
            ...
            foreach ($data['exercise'] as $exercise): ?>
                ...
                <div class="col-md-4 text-center mr-5 shadow-lg p-3 mb-5 bg-white rounded">
                   ...
                   <?php }
                    ...
                    <hr>
                    <?php  echo form_open('admin/edit_exercise'); ?>
                    ...
                    <?php } endforeach; ?>
                    <?php echo form_submit(['name'=> 'submit','value'=>'Edit Exercise','class'=>'btn btn-info w-75 p-2 ','id' => 'editExercise']); ?>
    ...
    <footer class="col-md-12" style="position:fixed;bottom:0;padding:0">
        <nav class="navbar navbar-light d-flex bd-highlight" style="background-color:#E9ECEF">
            <div class="mr-auto bd-highlight w-50">
                <a href="<?= base_url('admin/categories') ?>" class="btn btn-primary w-50"><i class="fas fa-arrow-left"></i> Back to Category</a>
            </div>
            <div class="p-1 bd-highlight">
                <h5 class=" mr-3">Add New Exercise:</h5>
            </div>
            <div class="bd-highlight">
                <button onclick="location.href='<?= base_url('admin/type') ?>'" id="add" class="button button5 btn "><b> <img src="<?= base_url() ?>assets/images/rightarrow.png" alt="Add New Exercise" height="40px" width="40px" > </b></button>
            </div>
        </nav>
    </footer>
