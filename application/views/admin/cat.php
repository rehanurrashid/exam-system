...
<html lang="en">
  ...
  <body id="body" class="body">
    <div class="jumbotron jumbotron-fluid ">
        <h2 class="text-primary ml-5">Admin: <span class="text-success">Screen: 1</span></h2>
    ...
    <footer class="col-md-12" style="position:fixed;bottom:0;padding:0">
        <nav class="navbar navbar-light d-flex flex-row-reverse" style="background-color:#E9ECEF">
            <a id="nextToExercise" href="<?= base_url('admin/exercise') ?>" class="btn btn-primary w-25">Next to Exercise <i class="fas fa-arrow-right"></i></a>
        </nav>
    </footer>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            ...
            <div class="form-group">
                ...
                <div class="modal-footer">
                    ...
                    <?php  echo form_open('admin/delete_cat'); ?>
